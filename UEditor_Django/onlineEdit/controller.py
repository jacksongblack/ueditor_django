...
from UEditor_Django.onlineEdit.image.image import Images
...
def getConfigContent():
    jsonfile = file(settings.BASE_DIR + "/onlineEdit/ueconfig.json")
...
def listFileManage(request, imageManagerListPath, imageManagerAllowFiles, listsize):
    ...
    localPath = settings.UPLOAD_ROOT + imageManagerListPath
    filelist = []
